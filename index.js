                ...
                getEventByIdEdit(dataRichiesta,dateTimeStart,titoloApp).then((event)=>{
                  if (event.length){
                    ...
                    getUpdate(id, dateStart2,oraStart2,titoloApp).then((strId)=>{
                      agent.add('ok spostato appuntamento ' +titoloApp +' in DATA ' + new Date(dateStart2).toLocaleDateString('it-IT') +',  alle ORE '+new Date(oraStart2).toLocaleTimeString(('it-IT')));
